...
//        $one->setListIsVisible(false);
        ...
        $one = new JQSelect("b.nama", "nama_service");
        $select_fields[] = $one;

        $one = new JQSelect("b.is_opsi_unit_service");
        $select_fields[] = $one;

        $one = new JQSelect("c.nama", "nama_opsi_unit_service");
        $select_fields[] = $one;
...
//        $select_fields[] = $one;
    ...
    public function get_model() {
        ...
        $model->join("a_service AS b", "b.id", "=", "a.id_service");
        $model->leftJoin("a_opsi_unit_service AS c", "c.id", "=", "a.id_opsi_unit_service");
