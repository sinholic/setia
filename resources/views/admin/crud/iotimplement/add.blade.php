...
{{ Form::open(array('route' => 'iotimplement.store', 'class' => 'form-horizontal')) }}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="start_date" type="text" class="datetimepicker-input datepicker-start form-control{{ $errors->has('start_date') ? ' is-invalid' : '' }}" name="start_date" value="{{ old('start_date') }}" data-toggle="datetimepicker" data-target=".datepicker-start">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="end_date" type="text" class="datetimepicker-input datepicker-end form-control{{ $errors->has('end_date') ? ' is-invalid' : '' }}" name="end_date" value="{{ old('end_date') }}" data-toggle="datetimepicker" data-target=".datepicker-end">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="v_unit" type="text" class="form-control{{ $errors->has('v_unit') ? ' is-invalid' : '' }}" name="v_unit" value="{{ old('v_unit') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="g_unit_byte" type="text" class="form-control{{ $errors->has('g_unit_byte') ? ' is-invalid' : '' }}" name="g_unit_byte" value="{{ old('g_unit_byte') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="moc_lo" type="text" class="form-control{{ $errors->has('moc_lo') ? ' is-invalid' : '' }}" name="moc_lo" value="{{ old('moc_lo') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="moc_bh" type="text" class="form-control{{ $errors->has('moc_bh') ? ' is-invalid' : '' }}" name="moc_bh" value="{{ old('moc_bh') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="moc_ot" type="text" class="form-control{{ $errors->has('moc_ot') ? ' is-invalid' : '' }}" name="moc_ot" value="{{ old('moc_ot') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="mtc" type="text" class="form-control{{ $errors->has('mtc') ? ' is-invalid' : '' }}" name="mtc" value="{{ old('mtc') }}">
            @if ($errors->has('mtc'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="sms_mo" type="text" class="form-control{{ $errors->has('sms_mo') ? ' is-invalid' : '' }}" name="sms_mo" value="{{ old('sms_mo') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="gprs" type="text" class="form-control{{ $errors->has('gprs') ? ' is-invalid' : '' }}" name="gprs" value="{{ old('gprs') }}">
            @if ($errors->has('gprs'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="premium" type="text" class="form-control{{ $errors->has('premium') ? ' is-invalid' : '' }}" name="premium" value="{{ old('premium') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="satelite" type="text" class="form-control{{ $errors->has('satelite') ? ' is-invalid' : '' }}" name="satelite" value="{{ old('satelite') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="exc_oth" type="text" class="form-control{{ $errors->has('exc_oth') ? ' is-invalid' : '' }}" name="exc_oth" value="{{ old('exc_oth') }}">
