...
{{ Form::open(array('route' => 'exchangerate.store', 'class' => 'form-horizontal')) }}
    <div class="form-group row">
        {{ Form::label('kode1', 'Kode 1', ['class' => 'col-sm-3 form-control-label']) }}
        <div class="col-sm-9">
            <input id="kode1" type="text" class="form-control{{ $errors->has('kode1') ? ' is-invalid' : '' }}" name="kode1" value="{{ old('kode1') }}"  autofocus>
            @if ($errors->has('kode1'))
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="kode2" type="text" class="form-control{{ $errors->has('kode2') ? ' is-invalid' : '' }}" name="kode2" value="{{ old('kode2') }}"  autofocus>
            @if ($errors->has('kode2'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="kode3" type="text" class="form-control{{ $errors->has('kode3') ? ' is-invalid' : '' }}" name="kode3" value="{{ old('kode3') }}"  autofocus>
            @if ($errors->has('kode3'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="rate" type="text" class="form-control{{ $errors->has('nilai') ? ' is-invalid' : '' }}" name="nilai" value="{{ old('nilai') }}" required autofocus>
            @if ($errors->has('nilai'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="ymd" type="text" class="form-control{{ $errors->has('ymd') ? ' is-invalid' : '' }}" name="ymd" value="{{ old('ymd') }}"  autofocus>
            @if ($errors->has('ymd'))
                <span class="invalid-feedback" role="alert">
