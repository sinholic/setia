...
{{ Form::model($menu, ['method' => 'PATCH', 'route' => ['menu.update', $menu->id], 'class' => 'form-horizontal']) }}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="kota" type="text" class="form-control{{ $errors->has('link_url') ? ' is-invalid' : '' }}" name="link_url" value="{{ $menu->link_url }}" required autofocus>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="is_show_on_sidebars" type="checkbox" {{ $menu->is_show_on_sidebar==1 ?'checked': '' }} autofocus>  Centang untuk ditambilkan di Sidebar
