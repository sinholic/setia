...
{{ Form::open(array('route' => 'target.store', 'class' => 'form-horizontal')) }}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input id="target" type="text" class="form-control{{ $errors->has('target') ? ' is-invalid' : '' }}" name="target" value="{{ old('target') }}"  autofocus>
